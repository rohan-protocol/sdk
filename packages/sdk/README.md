...
// 1. Initialize the Relayer Client (Fiat/API-driven — No Web3 Wallet needed)
const relayer = new RohanRelayerClient({
  relayerUrl: process.env.ROHAN_RELAYER_URL || 'https://api.rohanprotocol.network',
  contractAddress: '6d2d603235f996424d76c85186a79cc403245ea8ee1ba9087e40967fe71bdc4d', // Midnight Preprod
});
